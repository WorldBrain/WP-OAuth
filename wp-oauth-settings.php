...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<!-- START Login with WorldBrain section -->
			<div id="wpoa-settings-section-login-with-worldbrain" class="wpoa-settings-section">
			<h3>Login with WorldBrain</h3>
			<div class='form-padding'>
			<table class='form-table'>
				<tr valign='top'>
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='wpoa_worldbrain_api_enabled' value='1' <?php checked(get_option('wpoa_worldbrain_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='wpoa_worldbrain_api_id' value='<?php echo get_option('wpoa_worldbrain_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='wpoa_worldbrain_api_secret' value='<?php echo get_option('wpoa_worldbrain_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<!-- END Login with WorldBrain section -->
